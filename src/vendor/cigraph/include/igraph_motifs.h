...
IGRAPH_EXPORT igraph_error_t igraph_motifs_randesu_estimate(const igraph_t *graph, igraph_int_t *est,
                                                 igraph_int_t size, const igraph_vector_t *cut_prob,
                                                 igraph_int_t sample_size,
                                                 const igraph_vector_int_t *sample);
IGRAPH_EXPORT igraph_error_t igraph_motifs_randesu_no(const igraph_t *graph, igraph_int_t *no,
                                           igraph_int_t size, const igraph_vector_t *cut_prob);
