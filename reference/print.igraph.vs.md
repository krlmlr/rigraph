...
V(g2)
#> + 10/10 vertices, named, from b64b422:
#>  [1] A B C D E F G H I J

# All vertices in the sequence
g3 <- make_ring(1000)
V(g3)
#> + 1000/1000 vertices, from 89e76c1:
...
V(g4)[[]]
#> + 10/10 vertices, named, from 6758f06:
#>    name color
#> 1     A   red
#> 2     B   red
#> 3     C   red
...
#> 10    J   red
V(g4)[[2:5, 7:8]]
#> + 6/10 vertices, named, from 6758f06:
#>   name color
#> 2    B   red
#> 3    C   red
#> 4    D   red
