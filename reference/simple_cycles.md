...
#> $vertices
#> $vertices[[1]]
#> + 3/6 vertices, named, from 60fbd75:
#> [1] A B C
#> 
#> $vertices[[2]]
#> + 2/6 vertices, named, from 60fbd75:
#> [1] A F
#> 
#> $vertices[[3]]
#> + 1/6 vertex, named, from 60fbd75:
#> [1] E
#> 
#> 
#> $edges
#> $edges[[1]]
#> + 3/9 edges from 60fbd75 (vertex names):
#> [1] A->B B->C C->A
#> 
#> $edges[[2]]
#> + 2/9 edges from 60fbd75 (vertex names):
#> [1] A->F F->A
#> 
#> $edges[[3]]
#> + 1/9 edge from 60fbd75 (vertex names):
#> [1] E->E
#> 
#> 
...
#> 
#> $vertices[[2]]
#> + 4/6 vertices, named, from 60fbd75:
#> [1] A D E F
#> 
#> $vertices[[3]]
#> + 4/6 vertices, named, from 60fbd75:
...
#> 
#> $edges[[2]]
#> + 4/9 edges from 60fbd75 (vertex names):
#> [1] A->D D->E F->E F->A
#> 
#> $edges[[3]]
#> + 4/9 edges from 60fbd75 (vertex names):
