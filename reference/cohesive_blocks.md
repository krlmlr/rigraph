...
blocks(mwBlocks)
#> [[1]]
#> + 23/23 vertices, named, from 4dca778:
#>  [1] 1  2  3  4  5  6  7  21 8  11 14 19 9  10 12 13 16 15 17 18 20 22 23
#> 
#> [[2]]
#> + 14/23 vertices, named, from 4dca778:
#>  [1] 1  2  3  4  5  6  7  21 19 17 18 20 22 23
#> 
#> [[3]]
#> + 10/23 vertices, named, from 4dca778:
#>  [1] 7  8  11 14 9  10 12 13 16 15
#> 
#> [[4]]
#> + 7/23 vertices, named, from 4dca778:
#> [1] 1 2 3 4 5 6 7
#> 
#> [[5]]
#> + 4/23 vertices, named, from 4dca778:
#> [1] 7  8  11 14
#> 
cohesion(mwBlocks)
#> [1] 1 2 2 5 3
