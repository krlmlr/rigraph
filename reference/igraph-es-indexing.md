...
E(g)[1:3 %--% 2:6]
#> + 5/99 edges from 3bf7a61:
#> [1] 2->1 3->2 4->2 5->1 6->1
E(g)[1:5 %->% 1:6]
#> + 4/99 edges from 3bf7a61:
#> [1] 2->1 3->2 4->2 5->1
E(g)[1:3 %<-% 2:6]
#> + 5/99 edges from 3bf7a61:
#> [1] 2->1 3->2 4->2 5->1 6->1
...
d <- get_diameter(g)
E(g, path = d)
#> + 12/99 edges from e21734a:
#>  [1] 37--84 20--37 16--20 15--16  7--15  4-- 7  1-- 4  1--10 10--18 18--59
#> [11] 59--62 62--98
...
E(g)[[weight < 0]]
#> + 16/29 edges from e244771:
#>    tail head tid hid      weight
#> 1     2    3   2   3 -0.32718398
#> 3     4    6   4   6 -0.62787571
#> 4     1    9   1   9 -0.54059051
#> 7     6   11   6  11 -0.36747828
#> 8     8   11   8  11 -1.55775559
#> 11    3   13   3  13 -0.89810601
#> 12    4   13   4  13 -0.09822067
#> 13    5   13   5  13 -1.62457942
#> 17    6   15   6  15 -1.25259638
#> 18   11   15  11  15 -1.23933379
#> 21    8   17   8  17 -1.09210136
#> 22   13   17  13  17 -0.08385580
#> 25    1   19   1  19 -1.50450372
#> 26   16   19  16  19 -0.06058183
#> 27    4   20   4  20 -0.37817283
#> 29   19   20  19  20 -0.71161176
