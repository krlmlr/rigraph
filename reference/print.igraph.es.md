...
E(g2)
#> + 10/10 edges from dceb5dd (vertex names):
#>  [1] A--B B--C C--D D--E E--F F--G G--H H--I I--J A--J

# All edges in a long sequence
g3 <- make_ring(200)
E(g3)
#> + 200/200 edges from 36aca4a:
...
E(g4)
#> + 10/10 edges from f442753 (vertex names):
#>  [1] A--B B--C C--D D--E E--F F--G G--H H--I I--J A--J
E(g4)[[]]
#> + 10/10 edges from f442753 (vertex names):
...
E(g4)[[1:5]]
#> + 5/10 edges from f442753 (vertex names):
#>   tail head tid hid weight color
#> 1    A    B   1   2      1 green
#> 2    B    C   2   3      2 green
#> 3    C    D   3   4      3 green
