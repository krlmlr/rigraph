...
#> IGRAPH 802eda6 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 802eda6:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 5f8b475 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5f8b475:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 816758f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 816758f:
...
#> IGRAPH cdd3e22 D--B 15 20 -- Bipartite Gnm random graph
