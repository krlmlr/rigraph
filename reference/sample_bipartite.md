...
#> IGRAPH b9e0370 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b9e0370:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH a46cd85 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a46cd85:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 5d6e3b4 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5d6e3b4:
...
#> IGRAPH 070a199 D--B 15 20 -- Bipartite Gnm random graph
