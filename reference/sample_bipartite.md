...
#> IGRAPH d236539 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d236539:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 29b97fb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 29b97fb:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH f4f738e U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f4f738e:
...
#> IGRAPH 8045dae D--B 15 20 -- Bipartite Gnm random graph
