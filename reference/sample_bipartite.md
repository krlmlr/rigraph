...
#> IGRAPH b857d41 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b857d41:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 4c97749 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4c97749:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH e1ac30b U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e1ac30b:
...
#> IGRAPH 3c01463 D--B 15 20 -- Bipartite Gnm random graph
