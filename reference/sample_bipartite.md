...
#> IGRAPH b363e5d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b363e5d:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH aee4e9f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aee4e9f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 689215f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 689215f:
...
#> IGRAPH 7da14f7 D--B 15 20 -- Bipartite Gnm random graph
