...
#> IGRAPH 4abc006 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4abc006:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH b89495d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b89495d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9e62191 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9e62191:
...
#> IGRAPH bbf49c9 D--B 15 20 -- Bipartite Gnm random graph
