...
#> IGRAPH 9f4e687 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9f4e687:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 3fadcf6 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3fadcf6:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 5d494d9 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5d494d9:
...
#> IGRAPH 6e47552 D--B 15 20 -- Bipartite Gnm random graph
