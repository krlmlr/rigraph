...
#> IGRAPH a0eb2f9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a0eb2f9:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 766d8e0 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 766d8e0:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 8339c73 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8339c73:
...
#> IGRAPH 90b0e5a D--B 15 20 -- Bipartite Gnm random graph
