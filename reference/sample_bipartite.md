...
#> IGRAPH e9761f0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e9761f0:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH cd74bf4 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cd74bf4:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 030720f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 030720f:
...
#> IGRAPH 21b9c71 D--B 15 20 -- Bipartite Gnm random graph
