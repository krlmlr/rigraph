...
#> IGRAPH 8672b25 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8672b25:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 0d00cef U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0d00cef:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH db9aa62 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from db9aa62:
...
#> IGRAPH 1e3ddab D--B 15 20 -- Bipartite Gnm random graph
