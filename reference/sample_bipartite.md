...
#> IGRAPH 3b6c71a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3b6c71a:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 10dd64d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 10dd64d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH d90083f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d90083f:
...
#> IGRAPH 93e649a D--B 15 20 -- Bipartite Gnm random graph
