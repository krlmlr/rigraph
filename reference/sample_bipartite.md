...
#> IGRAPH 9c9855b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9c9855b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 9973ece U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9973ece:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH fd7778b U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fd7778b:
...
#> IGRAPH c0dd4b0 D--B 15 20 -- Bipartite Gnm random graph
