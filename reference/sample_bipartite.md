...
#> IGRAPH d5d53e6 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d5d53e6:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 25bc425 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 25bc425:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b4241d9 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b4241d9:
...
#> IGRAPH 41d13cb D--B 15 20 -- Bipartite Gnm random graph
