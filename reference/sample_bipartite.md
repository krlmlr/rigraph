...
#> IGRAPH 429e20a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 429e20a:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH b25dffc U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b25dffc:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH f561bc7 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f561bc7:
...
#> IGRAPH 466174b D--B 15 20 -- Bipartite Gnm random graph
