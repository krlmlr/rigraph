...
#> IGRAPH 9388978 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9388978:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 1afa3e8 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1afa3e8:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 30b7c73 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 30b7c73:
...
#> IGRAPH f2d0f0d D--B 15 20 -- Bipartite Gnm random graph
