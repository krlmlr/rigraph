...
#> IGRAPH 5f2ce2b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5f2ce2b:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH dfbf49b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dfbf49b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH ac75110 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ac75110:
...
#> IGRAPH 4e9e7a6 D--B 15 20 -- Bipartite Gnm random graph
