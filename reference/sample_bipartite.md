...
#> IGRAPH f18f73a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f18f73a:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 6465cb0 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6465cb0:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 0f33cd6 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0f33cd6:
...
#> IGRAPH 0c051ed D--B 15 20 -- Bipartite Gnm random graph
