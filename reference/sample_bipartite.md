...
#> IGRAPH c35c8d4 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c35c8d4:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 60794a5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 60794a5:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH a3e003f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a3e003f:
...
#> IGRAPH ee30b7d D--B 15 20 -- Bipartite Gnm random graph
