...
#> IGRAPH 7df4728 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7df4728:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 3d26a7f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3d26a7f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH b59f5cf U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b59f5cf:
...
#> IGRAPH 9485ec5 D--B 15 20 -- Bipartite Gnm random graph
