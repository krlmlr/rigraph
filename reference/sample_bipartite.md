...
#> IGRAPH 03f2bd4 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 03f2bd4:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH d506658 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d506658:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 59c692b U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 59c692b:
...
#> IGRAPH 489db97 D--B 15 20 -- Bipartite Gnm random graph
