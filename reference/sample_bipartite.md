...
#> IGRAPH df3f2aa U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from df3f2aa:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 6610fb3 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6610fb3:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 194d3de U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 194d3de:
...
#> IGRAPH cf5f220 D--B 15 20 -- Bipartite Gnm random graph
