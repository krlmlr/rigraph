...
#> IGRAPH cbd8487 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cbd8487:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH d1ccf0b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d1ccf0b:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH f5cad86 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f5cad86:
...
#> IGRAPH ae0b989 D--B 15 20 -- Bipartite Gnm random graph
