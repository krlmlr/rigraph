...
#> IGRAPH 3407e29 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3407e29:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 77b4fec U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 77b4fec:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 3da689c U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3da689c:
...
#> IGRAPH 090ad22 D--B 15 20 -- Bipartite Gnm random graph
