...
#> IGRAPH 728fb38 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 728fb38:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 5ecf175 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5ecf175:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 6715724 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6715724:
...
#> IGRAPH 57283f8 D--B 15 20 -- Bipartite Gnm random graph
