...
#> IGRAPH 21cb103 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 21cb103:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 34f920c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 34f920c:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH e227ab0 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e227ab0:
...
#> IGRAPH df7e0cc D--B 15 20 -- Bipartite Gnm random graph
