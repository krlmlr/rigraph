...
#> IGRAPH 457dca9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 457dca9:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH ace4d6f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ace4d6f:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 0de0293 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0de0293:
...
#> IGRAPH 638942d D--B 15 20 -- Bipartite Gnm random graph
