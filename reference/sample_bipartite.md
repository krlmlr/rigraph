...
#> IGRAPH 2bc07a8 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2bc07a8:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 3a0d733 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3a0d733:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH aca2ddc U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aca2ddc:
...
#> IGRAPH 7ab9c80 D--B 15 20 -- Bipartite Gnm random graph
