...
#> IGRAPH a61f0f0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a61f0f0:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH c32b045 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c32b045:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH e341f1d U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e341f1d:
...
#> IGRAPH dc9066e D--B 15 20 -- Bipartite Gnm random graph
