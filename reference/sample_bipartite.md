...
#> IGRAPH f6e71a0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f6e71a0:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH d3eb1ab U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d3eb1ab:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH e11807e U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e11807e:
...
#> IGRAPH a93107a D--B 15 20 -- Bipartite Gnm random graph
