...
#> IGRAPH 5f1d7db U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5f1d7db:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH da63412 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from da63412:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH f12010e U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f12010e:
...
#> IGRAPH e25ec31 D--B 15 20 -- Bipartite Gnm random graph
