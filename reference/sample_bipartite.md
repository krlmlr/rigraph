...
#> IGRAPH 578f287 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 578f287:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH cb262d7 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cb262d7:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 900fedb U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 900fedb:
...
#> IGRAPH cdead9a D--B 15 20 -- Bipartite Gnm random graph
