...
#> IGRAPH cdd7c5e U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cdd7c5e:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 345b14d U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 345b14d:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 226384d U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 226384d:
...
#> IGRAPH 257e705 D--B 15 20 -- Bipartite Gnm random graph
