...
#> IGRAPH 24b5803 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 24b5803:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH ef64dad U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ef64dad:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH d50a05f U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d50a05f:
...
#> IGRAPH 5bb6196 D--B 15 20 -- Bipartite Gnm random graph
