...
#> IGRAPH 78ae746 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 78ae746:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH f8ea5ed U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f8ea5ed:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 9d7fa9b U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9d7fa9b:
...
#> IGRAPH 98c0467 D--B 15 20 -- Bipartite Gnm random graph
