...
#> IGRAPH aedecbd U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from aedecbd:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 87120f8 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 87120f8:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH f91be71 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f91be71:
...
#> IGRAPH 94577a9 D--B 15 20 -- Bipartite Gnm random graph
