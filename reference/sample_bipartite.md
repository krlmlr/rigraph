...
#> IGRAPH 3a064c4 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3a064c4:

## full graph
sample_bipartite(10, 5, p = 1)
#> IGRAPH 069acd8 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 069acd8:
...
sample_bipartite(10, 5, p = .1)
#> IGRAPH 4d7a555 U--B 15 4 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4d7a555:
...
#> IGRAPH a6f3f96 D--B 15 20 -- Bipartite Gnm random graph
