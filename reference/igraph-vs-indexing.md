...
V(g)[.nei(c(2, 4))]
#> + 4/4 vertices, from 0947f38:
#> [1] 1 2 3 4
V(g)[.nei(c(2, 4), "in")]
#> + 3/4 vertices, from 0947f38:
#> [1] 1 2 4
V(g)[.nei(c(2, 4), "out")]
#> + 3/4 vertices, from 0947f38:
#> [1] 2 3 4
...
V(g)[.nei(c("B", "D"))]
#> + 4/4 vertices, named, from f64c8c0:
#> [1] A B C D
V(g)[.nei(c("B", "D"), "in")]
#> + 3/4 vertices, named, from f64c8c0:
#> [1] A B D
V(g)[.nei(c("B", "D"), "out")]
#> + 3/4 vertices, named, from f64c8c0:
#> [1] B C D
...
V(g)[color == "red"]
#> + 2/4 vertices, named, from 88e9643:
#> [1] A B
