...
V(g)[.nei(c(2, 4))]
#> + 4/4 vertices, from 3e65b01:
#> [1] 1 2 3 4
V(g)[.nei(c(2, 4), "in")]
#> + 3/4 vertices, from 3e65b01:
#> [1] 1 2 4
V(g)[.nei(c(2, 4), "out")]
#> + 3/4 vertices, from 3e65b01:
#> [1] 2 3 4
...
V(g)[.nei(c("B", "D"))]
#> + 4/4 vertices, named, from f801562:
#> [1] A B C D
V(g)[.nei(c("B", "D"), "in")]
#> + 3/4 vertices, named, from f801562:
#> [1] A B D
V(g)[.nei(c("B", "D"), "out")]
#> + 3/4 vertices, named, from f801562:
#> [1] B C D
...
V(g)[color == "red"]
#> + 2/4 vertices, named, from bd56e8d:
#> [1] A B
