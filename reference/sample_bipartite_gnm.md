...
#> IGRAPH 4f2af1c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4f2af1c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH d74a627 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d74a627:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 2e9d0c2 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2e9d0c2:
...
#> IGRAPH f22f152 D--B 15 20 -- Bipartite Gnm random graph
