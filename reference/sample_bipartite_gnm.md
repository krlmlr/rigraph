...
#> IGRAPH 2225227 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2225227:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 8304f86 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8304f86:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 713c565 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 713c565:
...
#> IGRAPH 45953f8 D--B 15 20 -- Bipartite Gnm random graph
