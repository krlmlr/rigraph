...
#> IGRAPH 8b5094d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8b5094d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 255b88b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 255b88b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 8dbd9b5 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8dbd9b5:
...
#> IGRAPH 0328c91 D--B 15 20 -- Bipartite Gnm random graph
