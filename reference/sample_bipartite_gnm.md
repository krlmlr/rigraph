...
#> IGRAPH 0e2d824 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0e2d824:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 5c2332a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5c2332a:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 42b5b46 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 42b5b46:
...
#> IGRAPH 697275e D--B 15 20 -- Bipartite Gnm random graph
