...
#> IGRAPH f870d12 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f870d12:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 1055c1f U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1055c1f:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH cd36bdd U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cd36bdd:
...
#> IGRAPH fdacd76 D--B 15 20 -- Bipartite Gnm random graph
