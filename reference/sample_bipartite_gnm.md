...
#> IGRAPH 05efbae U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 05efbae:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 7752274 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7752274:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 8cff242 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8cff242:
...
#> IGRAPH f5beb95 D--B 15 20 -- Bipartite Gnm random graph
