...
#> IGRAPH 2cda040 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2cda040:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH b97098e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b97098e:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 8fc83fc U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8fc83fc:
...
#> IGRAPH 32c063b D--B 15 20 -- Bipartite Gnm random graph
