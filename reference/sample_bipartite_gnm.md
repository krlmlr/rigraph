...
#> IGRAPH a7fa411 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a7fa411:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 7b102a6 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7b102a6:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 2c3ac9f U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2c3ac9f:
...
#> IGRAPH 8734cd3 D--B 15 20 -- Bipartite Gnm random graph
