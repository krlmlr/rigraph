...
#> IGRAPH 484b26b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 484b26b:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 700da78 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 700da78:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 2c916d0 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2c916d0:
...
#> IGRAPH 068c3f7 D--B 15 20 -- Bipartite Gnm random graph
