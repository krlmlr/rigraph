...
#> IGRAPH f44edc2 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f44edc2:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 25b571a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 25b571a:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH d8a4fba U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d8a4fba:
...
#> IGRAPH e3c8ee7 D--B 15 20 -- Bipartite Gnm random graph
