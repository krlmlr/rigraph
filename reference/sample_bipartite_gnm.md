...
#> IGRAPH 0400f56 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0400f56:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 12519af U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 12519af:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH ff4b7c8 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ff4b7c8:
...
#> IGRAPH c238217 D--B 15 20 -- Bipartite Gnm random graph
