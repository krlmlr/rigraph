...
#> IGRAPH c3b4402 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c3b4402:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 591d71b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 591d71b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 9354a12 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9354a12:
...
#> IGRAPH 9ddcd3f D--B 15 20 -- Bipartite Gnm random graph
