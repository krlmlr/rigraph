...
#> IGRAPH 4a543a8 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4a543a8:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 1274a69 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1274a69:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH f2ad087 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f2ad087:
...
#> IGRAPH 7a55836 D--B 15 20 -- Bipartite Gnm random graph
