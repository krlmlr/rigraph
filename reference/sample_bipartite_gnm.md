...
#> IGRAPH 26a29a3 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 26a29a3:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 9503c00 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9503c00:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 03ccddc U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 03ccddc:
...
#> IGRAPH 1e1426c D--B 15 20 -- Bipartite Gnm random graph
