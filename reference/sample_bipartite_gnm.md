...
#> IGRAPH d74636a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d74636a:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c810189 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c810189:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 5298bf3 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5298bf3:
...
#> IGRAPH 3061e30 D--B 15 20 -- Bipartite Gnm random graph
