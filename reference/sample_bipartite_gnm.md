...
#> IGRAPH 7fc3670 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7fc3670:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 26a22d1 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 26a22d1:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 249663a U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 249663a:
...
#> IGRAPH d119821 D--B 15 20 -- Bipartite Gnm random graph
