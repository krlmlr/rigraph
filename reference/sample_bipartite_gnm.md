...
#> IGRAPH ce71f51 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ce71f51:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 275b4b9 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 275b4b9:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b66440d U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b66440d:
...
#> IGRAPH 68613a5 D--B 15 20 -- Bipartite Gnm random graph
