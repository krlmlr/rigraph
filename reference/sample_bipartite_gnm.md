...
#> IGRAPH 7f11434 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7f11434:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 3bc1ef0 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3bc1ef0:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b4bac9c U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b4bac9c:
...
#> IGRAPH 8b5910d D--B 15 20 -- Bipartite Gnm random graph
