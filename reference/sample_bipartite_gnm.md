...
#> IGRAPH 38be984 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 38be984:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH f5cedeb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f5cedeb:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 1a07726 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1a07726:
...
#> IGRAPH 3bd6e1d D--B 15 20 -- Bipartite Gnm random graph
