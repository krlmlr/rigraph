...
#> IGRAPH 74324d1 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 74324d1:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 80a91b2 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 80a91b2:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH b2c724b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b2c724b:
...
#> IGRAPH 52e2891 D--B 15 20 -- Bipartite Gnm random graph
