...
#> IGRAPH db14e1d U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from db14e1d:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 6e8850b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 6e8850b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 30e81ae U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 30e81ae:
...
#> IGRAPH 7adc5f4 D--B 15 20 -- Bipartite Gnm random graph
