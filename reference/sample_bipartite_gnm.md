...
#> IGRAPH da13d94 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from da13d94:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e1b8940 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e1b8940:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 914fae3 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 914fae3:
...
#> IGRAPH e62f890 D--B 15 20 -- Bipartite Gnm random graph
