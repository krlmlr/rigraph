...
#> IGRAPH 143c327 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 143c327:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c33574b U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c33574b:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH c81e7a5 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c81e7a5:
...
#> IGRAPH f16bb0f D--B 15 20 -- Bipartite Gnm random graph
