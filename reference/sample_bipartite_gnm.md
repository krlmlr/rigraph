...
#> IGRAPH 987f974 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 987f974:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH ead3a45 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ead3a45:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 1cfe9fc U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 1cfe9fc:
...
#> IGRAPH ffca1bf D--B 15 20 -- Bipartite Gnm random graph
