...
#> IGRAPH bb804a7 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bb804a7:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 953f3c2 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 953f3c2:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH d9abc65 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from d9abc65:
...
#> IGRAPH a8e0ac4 D--B 15 20 -- Bipartite Gnm random graph
