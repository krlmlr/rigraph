...
#> IGRAPH e567737 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e567737:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 361cc8e U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 361cc8e:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH a59a0ef U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a59a0ef:
...
#> IGRAPH 9d535b4 D--B 15 20 -- Bipartite Gnm random graph
