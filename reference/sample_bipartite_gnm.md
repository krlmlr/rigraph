...
#> IGRAPH 633f2c7 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 633f2c7:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH f584c05 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f584c05:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 9c25cea U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9c25cea:
...
#> IGRAPH b573ff4 D--B 15 20 -- Bipartite Gnm random graph
