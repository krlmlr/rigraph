...
#> IGRAPH 8d5768a U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8d5768a:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 02c5b4c U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 02c5b4c:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH fd0f341 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fd0f341:
...
#> IGRAPH a6b7540 D--B 15 20 -- Bipartite Gnm random graph
