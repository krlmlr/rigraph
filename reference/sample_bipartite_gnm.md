...
#> IGRAPH fa3c619 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from fa3c619:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 5969db5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5969db5:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 0d79ae8 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0d79ae8:
...
#> IGRAPH 238d87f D--B 15 20 -- Bipartite Gnm random graph
