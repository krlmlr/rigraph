...
#> IGRAPH f31c0f5 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f31c0f5:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH f4ce0f6 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f4ce0f6:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 4c11469 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4c11469:
...
#> IGRAPH d0c7383 D--B 15 20 -- Bipartite Gnm random graph
