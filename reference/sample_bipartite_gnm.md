...
#> IGRAPH caa947b U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from caa947b:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 7013bc1 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 7013bc1:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH a8b846b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a8b846b:
...
#> IGRAPH 886fb00 D--B 15 20 -- Bipartite Gnm random graph
