...
#> IGRAPH 4a3a0f2 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4a3a0f2:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 4c9b5eb U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 4c9b5eb:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH e65e02b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e65e02b:
...
#> IGRAPH 1b5bf16 D--B 15 20 -- Bipartite Gnm random graph
