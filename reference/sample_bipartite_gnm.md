...
#> IGRAPH bf1a816 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from bf1a816:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 42e5ced U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 42e5ced:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 9732a7f U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9732a7f:
...
#> IGRAPH 1ccd211 D--B 15 20 -- Bipartite Gnm random graph
