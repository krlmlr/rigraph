...
#> IGRAPH 9d07975 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9d07975:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH c59d0d2 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c59d0d2:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH cc8854b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from cc8854b:
...
#> IGRAPH 3b29f04 D--B 15 20 -- Bipartite Gnm random graph
