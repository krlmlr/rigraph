...
#> IGRAPH ad398ff U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from ad398ff:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH e9b558a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from e9b558a:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH a174040 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a174040:
...
#> IGRAPH 2609fd4 D--B 15 20 -- Bipartite Gnm random graph
