...
#> IGRAPH 097d674 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 097d674:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 73743a5 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 73743a5:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH c4f7090 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from c4f7090:
...
#> IGRAPH 30648eb D--B 15 20 -- Bipartite Gnm random graph
