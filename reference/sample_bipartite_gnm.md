...
#> IGRAPH 3836111 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 3836111:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH b87e273 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from b87e273:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH f13d226 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from f13d226:
...
#> IGRAPH 3600a8d D--B 15 20 -- Bipartite Gnm random graph
