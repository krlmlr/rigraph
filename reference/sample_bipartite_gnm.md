...
#> IGRAPH 2b0e12c U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 2b0e12c:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH dfa7674 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from dfa7674:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 128f70b U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 128f70b:
...
#> IGRAPH 061005c D--B 15 20 -- Bipartite Gnm random graph
