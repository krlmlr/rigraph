...
#> IGRAPH 9f4e4b1 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9f4e4b1:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 09b3b94 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 09b3b94:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH a3f4944 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from a3f4944:
...
#> IGRAPH 5542f9b D--B 15 20 -- Bipartite Gnm random graph
