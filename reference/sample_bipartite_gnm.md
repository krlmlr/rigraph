...
#> IGRAPH 9b537e0 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 9b537e0:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 5a4ae04 U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5a4ae04:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 5bcad5d U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 5bcad5d:
...
#> IGRAPH 5e4ff2f D--B 15 20 -- Bipartite Gnm random graph
