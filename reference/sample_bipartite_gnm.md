...
#> IGRAPH 8e9e1a9 U--B 15 0 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 8e9e1a9:

## full graph
sample_bipartite_gnp(10, 5, p = 1)
#> IGRAPH 32fd02a U--B 15 50 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 32fd02a:
...
sample_bipartite_gnp(10, 5, p = .1)
#> IGRAPH 0d9b033 U--B 15 6 -- Bipartite Gnp random graph
#> + attr: name (g/c), p (g/n), type (v/l)
#> + edges from 0d9b033:
...
#> IGRAPH 57707b5 D--B 15 20 -- Bipartite Gnm random graph
