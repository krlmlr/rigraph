...
g
#> IGRAPH edf1e23 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from edf1e23 (vertex names):
...
g2
#> IGRAPH 7f90900 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 7f90900 (vertex names):
...
g3
#> IGRAPH 37b1ada DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 37b1ada (vertex names):
...
g4
#> IGRAPH 1a1d74b UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 1a1d74b (vertex names):
...
g5
#> IGRAPH 4dc0ad1 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 4dc0ad1 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 9d4a24f UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 9d4a24f (vertex names):
#> [1] + ---   * --/   %%--%/%
```
