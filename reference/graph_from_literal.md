...
g
#> IGRAPH 1799fc1 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 1799fc1 (vertex names):
...
g2
#> IGRAPH e997556 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from e997556 (vertex names):
...
g3
#> IGRAPH b0c792e DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from b0c792e (vertex names):
...
g4
#> IGRAPH 5d2bef7 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 5d2bef7 (vertex names):
...
g5
#> IGRAPH de87605 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from de87605 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 9b984cf UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 9b984cf (vertex names):
#> [1] + ---   * --/   %%--%/%
```
