...
g
#> IGRAPH afd95fe UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from afd95fe (vertex names):
...
g2
#> IGRAPH 11e5f47 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 11e5f47 (vertex names):
...
g3
#> IGRAPH b893bf0 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from b893bf0 (vertex names):
...
g4
#> IGRAPH fd47f81 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from fd47f81 (vertex names):
...
g5
#> IGRAPH 93d5c01 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 93d5c01 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 5195a18 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 5195a18 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
