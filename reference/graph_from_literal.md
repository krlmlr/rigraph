...
g
#> IGRAPH 43f828f UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 43f828f (vertex names):
...
g2
#> IGRAPH 3d5194d UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 3d5194d (vertex names):
...
g3
#> IGRAPH e28eeb6 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from e28eeb6 (vertex names):
...
g4
#> IGRAPH 212db06 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 212db06 (vertex names):
...
g5
#> IGRAPH 6df4919 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 6df4919 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH b72866f UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from b72866f (vertex names):
#> [1] + ---   * --/   %%--%/%
```
