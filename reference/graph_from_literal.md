...
g
#> IGRAPH 3f46595 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 3f46595 (vertex names):
...
g2
#> IGRAPH 6c36142 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 6c36142 (vertex names):
...
g3
#> IGRAPH 2b60a6b DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 2b60a6b (vertex names):
...
g4
#> IGRAPH 1e7cb65 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from 1e7cb65 (vertex names):
...
g5
#> IGRAPH 132b7c7 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 132b7c7 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 100cff8 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 100cff8 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
