...
g
#> IGRAPH 1f72455 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 1f72455 (vertex names):
...
g2
#> IGRAPH 034f028 UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from 034f028 (vertex names):
...
g3
#> IGRAPH 369a4d1 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 369a4d1 (vertex names):
...
g4
#> IGRAPH dfe3675 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from dfe3675 (vertex names):
...
g5
#> IGRAPH d605ab3 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from d605ab3 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 6c191b6 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 6c191b6 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
