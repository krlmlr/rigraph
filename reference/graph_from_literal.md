...
g
#> IGRAPH 30d24b3 UN-- 6 6 -- 
#> + attr: name (v/c)
#> + edges from 30d24b3 (vertex names):
...
g2
#> IGRAPH a13d27f UN-- 6 7 -- 
#> + attr: name (v/c)
#> + edges from a13d27f (vertex names):
...
g3
#> IGRAPH 9535013 DN-- 7 6 -- 
#> + attr: name (v/c)
#> + edges from 9535013 (vertex names):
...
g4
#> IGRAPH e9fc702 UN-- 6 2 -- 
#> + attr: name (v/c)
#> + edges from e9fc702 (vertex names):
...
g5
#> IGRAPH 45577b2 DN-- 2 2 -- 
#> + attr: name (v/c)
#> + edges from 45577b2 (vertex names):
#> [1] Alice->Bob   Bob  ->Alice

# Special vertex names
g6 <- graph_from_literal("+" -- "-", "*" -- "/", "%%" -- "%/%")
g6
#> IGRAPH 0689f90 UN-- 6 3 -- 
#> + attr: name (v/c)
#> + edges from 0689f90 (vertex names):
#> [1] + ---   * --/   %%--%/%
```
