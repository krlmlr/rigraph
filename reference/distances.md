...
#> $vpath
#> $vpath[[1]]
#> + 5/10 vertices, from ff9c06b:
#> [1] 5 4 3 2 1
#> 
#> $vpath[[2]]
#> + 4/10 vertices, from ff9c06b:
#> [1] 5 4 3 2
#> 
#> $vpath[[3]]
#> + 3/10 vertices, from ff9c06b:
#> [1] 5 4 3
#> 
#> $vpath[[4]]
#> + 2/10 vertices, from ff9c06b:
#> [1] 5 4
#> 
#> $vpath[[5]]
#> + 1/10 vertex, from ff9c06b:
#> [1] 5
#> 
#> $vpath[[6]]
#> + 2/10 vertices, from ff9c06b:
...
#> 
#> $epaths[[3]]
#> + 4/10 edges from ff9c06b:
#> [1] 1--10 9--10 8-- 9 7-- 8
#> 
#> $epaths[[4]]
#> + 3/10 edges from ff9c06b:
#> [1] 1--10 9--10 8-- 9
#> 
#> 
#> $nrgeo
